...
const PrivacyPolicy = () => {
  return (
    <div id="privacy-policy">
      ...
      <p>
        Effective date: <span className="date">2020-10-15</span>
      </p>
      <p>
        <span className="num">1</span>. <b>Introduction</b>
      </p>
      <p>
        Welcome to{" "}
        <b>
      ...
      <p>
        ...
        <b>
          <span className="url">https://esportsglobal.netlify.app/</span>
        </b>{" "}
      ...
      <p>
        <span className="num">2</span>. <b>Definitions</b>
      </p>
      <p>
        <b>SERVICE</b> means the{" "}
        <span className="url">https://esportsglobal.netlify.app/</span> website
        operated by <span className="company-name">Esports Global</span>.
      </p>
      <p>
      ...
      <p>
        <span className="num">3</span>. <b>Information Collection and Use</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">4</span>. <b>Types of Data Collected</b>
      </p>
      <p>
        <b>Personal Data</b>
      </p>
      ...
      <p>
        <span className="num">7</span>. <b>Transfer of Data</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">13</span>. <b>Service Providers</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">14</span>. <b>Analytics</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">15</span>. <b>CI/CD tools</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">16</span>. <b>Behavioral Remarketing</b>
      </p>
      <p>
      ...
      <div id="payments"></div>
      <p>
        <span className="num">17</span>. <b>Links to Other Sites</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">19</span>. <b>Changes to This Privacy Policy</b>
      </p>
      <p>
      ...
      <p>
        <span className="num">20</span>. <b>Contact Us</b>
      </p>
      <p>
